...
def organism_selection(path__, sel = 1):
    """This function completes the peptide output from Proteime Discoverer with the protein and organism they belong
        ...
        sel = integer
            sel = 1: a selection based on the representation of each specie is performed for non-unique peptides
    ...
    if sel == 2:
        ...
        for i in range(df.shape[0]):
            df.loc[i,'Protein Name'] = protein_name_simplification(df.loc[i,'Protein Name'], uni = 1) #uni has to be 1        
