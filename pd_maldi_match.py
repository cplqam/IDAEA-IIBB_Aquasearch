...
def xml_complete(xml_, ident_pep, ident_prot, n_ = 250, ppm = 100, unique_ = 2):
    """Assigns the protein and organism name to the MALDI spectrum signals
        ...
        ppm: integer. Maximum error allowed for considering a signal from MALDI and Orbitrap  as the same.
             default ppm = 100
        unique_: integer.
                 unique_ = 2, all the posibilities are considered in non-unique peptides
...
if __name__ == '__main__':
    ...
    result_1 = xml_complete('test_files/mcE61_Figueres.xml',
                          ...
                          'test_files/mcE61_PD14_Figueres_Proteins.xlsx', n_ = 100, unique_= 2)
